...
function makePanel() {
    ...
    return function Panel() {
        ...
        useEffect(() => { if (status && status.transfers && status.transfers.length)
            setOpenSections(previous => previous.transfers ? previous : { ...previous, transfers: true }); }, [status && status.transfers && status.transfers.length]);
